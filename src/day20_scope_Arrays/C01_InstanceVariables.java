...
public class C01_InstanceVariables {
    ...
    public static void main(String[] args) {
        ...
        // sayi=20;
        // sayi variable static olmadigi icin main method da direk kullanilamaz
        // instance variable lara static method lardan ulasabilmek icin obje olusturmamiz gerekir


        C01_InstanceVariables obj1=new C01_InstanceVariables();    // obj1 olusturulan nokta   *************
        ...
        C01_InstanceVariables obj2 = new C01_InstanceVariables();   // obj2 olusturulan nokta   *************
