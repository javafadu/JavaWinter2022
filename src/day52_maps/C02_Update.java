...
public class C02_Update {
    /*
    Verilen map deki tum brans lari Java yapalim

    Map de value kompleks olabildigi icin
    value icerisinden bir bolumu degistirmek istersek
    once vlaue ya ulasmak ve sonra manipule ederek istedigimiz
    degisikligi yapmak ve en sonunda degismi halini yeniden
